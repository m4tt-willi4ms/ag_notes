...
The notes were prepared using <a target="_blank" href="https://jupyterbook.org/en/stable/intro.html">JupyterBook</a>, in part to
...
computer algebra library <a target="_blank" href="https://www.sympy.org">SymPy</a> to
demonstrate/check the claims being made, or generate a plot using
<a target="_blank" href="https://jupyterbook.org/en/stable/intro.html">matplotlib</a>. If the
reader wishes to run these notebooks themselves, the source code for this
website can be found <a target="_blank" href="https://github.com/m4tt-willi4ms/ag_notes">here</a>.
